...
private:
	...
	declare Sub ActionFalling( byval SnipeX as integer, Map() as TileType )
	...
	declare Sub ActionFly( byref SnipeX as Player, byref Bullets as BulletFactory, Map() as TileType )
...
private:
	...
	as BossGyrobot BossGyrobots(MAX_BOSSGYROBOTS)
