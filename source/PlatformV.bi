...
type PlatformV
	...
	declare sub CollideWithPlayer( byref Snipe as Player, Map() as TileType )
...
public:
	...
	declare sub HandleCollisions( byref Snipe as Player, Map() as TileType )
...
private:
	...
	as PlatformV PlatformVs(MAX_PLATFORMVS)
