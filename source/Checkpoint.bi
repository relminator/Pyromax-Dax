...
type Checkpoint
	...
	declare function CollideWithPlayer( byref Snipe as Player, byref SpawnX as integer, byref SpawnY as integer ) as integer
...
private:
	...
	declare Sub ActionVanish( Map() as TileType )
	...
	as integer VanishCounter
	as single  VanishInterpolator
	as single  VanishX
...
public:
	...
	declare function HandleCollisions( byref Snipe as Player, byref SpawnX as integer, byref SpawnY as integer  ) as integer
	declare sub SortEntities()
...
private:
	...
	as Checkpoint Checkpoints(MAX_CHECKPOINTS)
